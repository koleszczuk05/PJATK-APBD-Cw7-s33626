...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 2, 10, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Budget Starter",
                            Stock = 8,
                            Warranty = 12,
                            Weight = 7.1f
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.PCComponent", b =>
                {
                    b.Property<int>("PCid")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.Component", b =>
                {
                    b.HasOne("PJATK_APBD_Cw7_s33626.Models.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw7_s33626.Models.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33626.Models.PCComponent", b =>
                {
                    b.HasOne("PJATK_APBD_Cw7_s33626.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw7_s33626.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
